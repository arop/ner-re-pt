...
# Source: https://15082639466769075924.googlegroups.com/attach/ff67f676c35e19ee/anntoxml.py?part=0.1&view=1&vt=ANaJVrHJorTtcMBlnxnEI0MZ_MbDv5YoDoAg7sVbYNMn8FM4rpw8wxlreL1rUJEa6vu24Y7wPehv9QTaFgw4BfJs7neuzEW4jNWFx7yd3lnqCHRkaNSYiac
# edited: Andre Pires - andre.r.o.pires@gmail.com
...
def start_tag(entity):
    ...
    return u'<EM CATEG="%s">' % ' '.join(attrlist)
