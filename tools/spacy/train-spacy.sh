...
# do
# 	printf '\n*** fold '$i' ***\n'
# 	TRAIN=../../scripts/filter-harem/harem-to-standoff/outputs/fold-$i
...
TRAIN=../../scripts/filter-harem/harem-to-standoff/outputs/fold-0
python "src/ner-train-spacy.py" $TRAIN"/cat_train-standoff" "models/fold-0" cat 