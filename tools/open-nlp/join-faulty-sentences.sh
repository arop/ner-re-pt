...
python "src/join-faulty-sentences.py" "outputs/filtered_all_sent_doc.xml" "outputs/filtered_all_sent_doc.xml"
python "src/join-faulty-sentences.py" "outputs/filtered_train_sent_doc.xml" "outputs/filtered_train_sent_doc.xml"
python "src/join-faulty-sentences.py" "outputs/filtered_test_sent_doc.xml" "outputs/filtered_test_sent_doc.xml"