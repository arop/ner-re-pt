...
print('total: ',sum(times_cat+times_types+times_subtypes+times_filtered)) #5370s - 1h30
print('total without filtered: ', sum(times_cat+times_types+times_subtypes)) #4719s - 1h19