...
for v in values:
	one = open('repeat-'+repeat+'/ner-results/experiences/'+param+'/'+v+'/out-'+level+'-iob.txt','r').read().splitlines()
	two = open('repeat-'+repeat+'/joined/t_'+level+'_test-iob.txt','r').read().splitlines()
