...
do
	...
	do
		...
		CLASSIFIER=../../models/repeat-$r/fold-$i/filtered-ner-model.ser.gz
		TXT=../../outputs/repeat-$r/fold-$i/t_filtered_test.txt-clean.txt
		OUT=../../outputs/repeat-$r/ner-results/fold-$i/out-filtered.txt
