...
do
	...
	do
		...
		CLASSIFIER=../../models/repeat-$r/experiences/max-iterations/$v/cat-ner-model.ser.gz
		TXT=../../outputs/repeat-$r/experiences/max-iterations/$v/t_cat_test.txt-clean.txt
		OUT=../../outputs/repeat-$r/ner-results/experiences/max-iterations/$v/out-cat.txt
