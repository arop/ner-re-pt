...
do
	...
	do
		...
		CLASSIFIER=../../models/repeat-$r/fold-$i/subtypes-ner-model.ser.gz
		TXT="../../outputs/repeat-"$r"/fold-"$i"/t_subtypes_test.txt-clean.txt"
		OUT=../../outputs/ner-results/fold-$i/out-subtypes.txt
